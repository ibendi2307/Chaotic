...
public class ModConfigFeature {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, OVERWORLD_URANIUM_ORE_KEY, Feature.ORE,
                ...
                OreConfiguration.target(stoneReplacebale, BlockRegistry.Uraniumore.get().defaultBlockState())),9));
    }

    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, Identifier.fromNamespaceAndPath(Chaotic.MODID, name));
    }
